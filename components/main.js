  ...
  return (
    <>
      <section id="HOME" className="bg-white dark:bg-gray-900" >
        <div className="grid max-w-full px-8 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-0 lg:grid-cols-12 lg:pt-28">
          <div className="mr-auto  place-self-center lg:col-span-7">
            <h1
              data-aos="fade-right"
              className="max-w-full mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-xl xl:text-6xl dark:text-white"
            >
              Noticias <br />
              Produtos & Marcas
            </h1>
            <p
              ...
              className="max-w-full mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"
            >
            ...
            <li>
              <Link
                ...
                className="text-gray-500 hover:text-gray-900 dark:hover:text-white dark:text-gray-400" target="_blank"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          >
            <img src="/capa.png" alt="hero image" />
          </div>
        </div>
      <Carousel /> 
