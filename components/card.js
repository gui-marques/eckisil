...
const card = () => {
  return (
    ...
    <section id="FEACHER" className="bg-white ">
      <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
        <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
          <h2
            ...
            data-aos-once="false"
            className="mb-4 text-3xl font-extrabold tracking-tight text-blue-400"
          >
          ...
          <p
            ...
            data-aos-easing="ease-in-out"
            data-aos-once="false"
            className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-700"
          >
